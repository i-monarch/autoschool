          ...
          {navItems.map((item) => {
            ...
            return (
              ...
              >
                ...
                {item.href === '/teacher/chat' && totalUnread > 0 && (
                  <span className="ml-auto bg-secondary text-secondary-content text-xs font-bold rounded-full min-w-5 h-5 px-1 flex items-center justify-center">
