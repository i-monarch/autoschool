  ...
  return (
    <div className="h-[calc(100vh-10rem)] lg:h-[calc(100vh-7rem)] flex flex-col">
      <div className="mb-4">
        ...
        <p className="text-base-content/60 text-sm mt-1">Чат з учнями</p>
      </div>
          ...
          <div className="flex-1 flex items-center justify-center p-8">
            <div className="text-center">
              ...
              <p className="text-base-content/60 max-w-sm text-sm">
                Оберіть учня зі списку, щоб почати спілкування.
              </p>
            </div>
          </div>
          ...
          <div className="p-3 border-t border-base-300/40">
            <div className="flex gap-2">
              <input
                ...
                disabled
              />
              <button className="btn btn-secondary btn-sm btn-square" disabled>
